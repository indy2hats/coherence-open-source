...
<tbody style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;" >
	...
	<div class="heading-section" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;text-align:left;padding-top:0px;padding-bottom:0px;padding-right:0px;padding-left:0px;" >
		...
		@if(in_array($user->id, $task->approvers->pluck('id')->toArray()))
			<p style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;margin-top:0;" >A task which you have to approve for completion with the following details has been created.</p>
		@else
			<p style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;margin-top:0;" >A task with the following details has been assigned to you.</p>
		@endif
	</div>
