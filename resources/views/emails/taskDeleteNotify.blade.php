        ...
        <tr style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;">
            <td class="bg_white email-section"
                ...
                <div class="heading-section"
                    ...
                    <p style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;margin-top:0;">The task - {{$task->title}} has been deleted</p>
                </div>
            </td>
        </tr>
        <tr style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;">
