...
<table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
    ...
    <tbody style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;">
        <tr style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;">
            <td class="bg_white email-section"
                ...
                <div class="heading-section"
                    ...
                    <p style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;margin-top:0;">{{$task->creator->full_name}}
                        have created task with the following details.</p>
                </div>
        ...
        <tr style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;">
            <td class="bg_white email-section"
                style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;width:100%;mso-table-lspace:0pt !important;mso-table-rspace:0pt !important;background-color:#ffffff;background-image:none;background-repeat:repeat;background-position:top left;background-attachment:scroll;padding-top:2.5em;padding-bottom:2.5em;padding-right:2.5em;padding-left:2.5em;">
                                    ...
                                    <tbody style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;">
                                        <tr
                                            ...
                                            <td class="text-services"
                                                style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;text-align:left;padding-right:25px;mso-table-lspace:0pt !important;mso-table-rspace:0pt !important;padding-top:10px;padding-bottom:0;padding-left:10px;">
                                                ...
                                                <div class="services-list"
                                                    ...
                                                    <div class="text"
                                                        ...
                                                        <p
                                                            style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;margin-top:0;margin-bottom:0;margin-right:0;margin-left:0;">
                                                            {{number_format($task->estimated_time,2)}} Hours
                                                        </p>
                                                    </div>
                                                </div>
                                                @if($task->users)
                                                ...
                                                <div class="services-list"
                                                    ...
                                                    <div class="text"
                                                        ...
                                                        <h3
                                                            style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;font-family:'Work Sans', sans-serif;color:#000000;font-size:18px;font-weight:400;margin-top:0;margin-bottom:0;">
                                                            Should Be Approved By</h3>
                                                        <p
                                                            style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;margin-top:0;margin-bottom:0;margin-right:0;margin-left:0;">
                                                            @foreach($task->approvers as $user)
                                                                {!! $user->full_name !!}
                                                                <br>
                                                            @endforeach
                                                ...
                                                @endif
                                                <p
                                                    style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;margin-top:0;text-align: center;min-width: 300px;">
                                                    <a href="{{url('/tasks/'.$task->id)}}"
                                                        class="btn btn-primary" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;text-decoration:none;color:#fff;border-radius: 2rem;
