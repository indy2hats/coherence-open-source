<!-- Create Task Modal -->
<div id="add_issue" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                <h4 class="modal-title text-center">Add New Issue</h4>
            </div>
            <div class="modal-body">
                <form action="{{route('issue-records.store')}}" id="add_issue_form" method="POST" autocomplete="off">
                    @csrf
                                        <div class="row">
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea rows="4" class="form-control summernote" placeholder="Enter your issue here" name="description"></textarea>
                                            <div class="text-danger text-left field-error" id="label_description"></div>
                                        </div>

                                        <div class="form-group">
                                            <label>Solution <span class="required-label">*</span></label>
                                            <textarea rows="4" class="form-control summernote" placeholder="Enter your solution here" name="solution"></textarea>
                                            <div class="text-danger text-left field-error" id="label_solution"></div>
                                        </div>
                                   
                    <div class="submit-section mt20">
                        <button class="btn btn-primary submit-btn create-issue">Submit</button>
                    </div>
                </form>
            </div>
        </div>
