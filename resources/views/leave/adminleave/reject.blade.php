    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-center">Reject Leave</h4>
            </div>
            <div class="modal-body">
                <form action="{{route('rejectLeave')}}" id="leave_rejection_form" method="POST" autocomplete="off">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <input type="hidden" id="reject_leave_id" value="" name="leave_id">
                </form>
