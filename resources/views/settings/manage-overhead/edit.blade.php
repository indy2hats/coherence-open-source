...
<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{route('fixed-overhead.update',$overhead->id)}}" id="edit_overhead_type_form" method="POST" autocomplete="off">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter the type" class="form-control" name="type" id="edit_type_id" value="{{$overhead->type}}"/>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="amount" id="edit_amount_id" value="{{$overhead->amount}}">
                ...
                <div class="submit-section">
                    <button class="btn btn-primary submit-btn update-overhead-type">Update</button>
                </div>
        </div>
    </div>
</div>
