<div id="add_attributes" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                <h4 class="modal-title text-center">Add New Attributes</h4>
            </div>
            ...
            <div class="modal-body">
                ...
                <div class="append-new">
                    <div class="row" style="padding-top:10px;">
                        ...
                        <div class="col-sm-8 new-attribute-value-list">
                            <div class="row"  style="margin-bottom: 5px;">
                                ...
                                <div class="col-sm-2 attribute-actions">    
