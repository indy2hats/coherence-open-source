...
<div>
    ...
    <div class="row">
        <div class="col-md-7 pull-left">
            <strong>
                <h2 class="page-title">Tasks</h3>
            </strong>
        </div>
        @can('manage-tasks')
        <div class="col-md-5 text-right ml-auto m-b-30">
            <a href="" class="btn btn-w-m btn-success create-modal"><i class="ri-add-line"></i> Add Task</a>
        </div>
        @endcan
    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-md-6">
                                                <div class="form-group form-focus select-focus focused">
                                                    ...
                                                    <select class="chosen-select" id="select_project_name"
                                                        name="project_id">
