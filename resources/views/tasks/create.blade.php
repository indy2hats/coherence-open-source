    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('tasks.store')}}" enctype="multipart/form-data" id="add_task_form" method="POST" autocomplete="off">
                    <input type="hidden" name="project_id" value="{{$project->id}}">
                    @csrf
                    <div class="tabs-container">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="active"><a class="nav-link" data-toggle="tab" href="#tab-1"> Task Details</a></li>
                                @unlessrole('client')
                                    ...
                                    <div class="panel-body">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group form-focus select-focus focused">
                                                    ...
                                                    <select class="chosen-select" id="task_parent" name="task_parent">
                                                        ...
                                                        @forelse ($parentTasks as $taskItem)
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    <label>URL</label>
                                                    <input class="form-control" type="text" name="task_url" id="url">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea rows="4" class="form-control summernote" placeholder="Enter your message here" name="task_description"></textarea>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6 col-md-6">
                                                <div class="form-group form-focus select-focus focused">
                    ...
                    <div class="submit-section mt20">
                        <button class="btn btn-primary submit-btn create-task">Submit</button>
                    </div>
                </form>
            </div>
        </div>
