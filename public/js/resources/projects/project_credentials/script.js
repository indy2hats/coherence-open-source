    ...
    $(document).ready(function() {
        ...
        $('.create-new').click(function(e) {
            ...
            var data = new FormData($('#create_credential_id')[0]);
            $.ajax({
                method: 'POST',
        ...
        $('#create_credential').on('hidden.bs.modal', function() {
            ...
            $('.create_credential_form').trigger('reset');
        });
        ...
        $(document).on('click', '#delete_credential .continue-btn', function() {
            ...
            $.ajax({
                type: 'DELETE',
                url: '/project-credentials/' + deletefileId ,
                data:{},
                success: function(response) {
                    $(".overlay").remove();
        ...
        $(document).on('click', '.edit-data', function(e) {
            ...
            var id = $(this).data('id');
            $("body").append('<div class="overlay"><div class="overlay__inner"><div class="overlay__content"><span class="spinner"></span></div></div></div>');
            editUrl = '../../project-credentials/' + id + '/edit';
            $.ajax({
                method: 'GET',
                url: editUrl,
                data: {},
        ...
        $(document).on('click', '.update-data', function(e) {
            ...
            e.preventDefault();
            $("body").append('<div class="overlay"><div class="overlay__inner"><div class="overlay__content"><span class="spinner"></span></div></div></div>');
            var data = new FormData($('#edit_credential_id')[0]);
            $.ajax({
                method: 'POST',
